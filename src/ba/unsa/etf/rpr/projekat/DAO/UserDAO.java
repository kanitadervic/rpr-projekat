...
//        }
    ...
    public ArrayList<User> getAllUsers() {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:sqlite:users.db");
            preparedStatement = connection.prepareStatement("Select first_name, last_name, email, phone_number, password, gender, birthdate, id, doctor from user");
            ResultSet rs = preparedStatement.executeQuery();
            while (rs.next()) {
                User u;
    ...
    public ObservableList<Doctor> getDoctorUsers() {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:sqlite:users.db");
            preparedStatement = connection.prepareStatement("Select first_name, last_name, email, phone_number, password, gender, birthdate, id from user WHERE doctor= ?");
    ...
    public boolean checkIfDoctor(User u) {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:sqlite:users.db");
            preparedStatement = connection.prepareStatement("SELECT doctor FROM user WHERE id=?");
    ...
    public Doctor findDoctorById(int doctorId) {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:sqlite:users.db");
            preparedStatement = connection.prepareStatement("Select first_name, last_name, email, phone_number, password, gender, birthdate, id, doctor from user WHERE id= ?");
